...
export const ssrProductionHandler = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    const { render } = await import(path.join(CLIENT_PACKAGE_PATH, './dist-ssr/ssr-entry.cjs'));
